...
<body>
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" action="/1217/login" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="/1217/captcha.jpg" id="captcha" style="width:80px;height:35px"/>
							</div>
						</div>
						<div class="form-group">
	...
	<script>
		var oimg = document.getElementById("captcha");
		// 增加监视器，监视点击行为
		oimg.onclick = function(){
			// 将请求src地址增加随机数，表示每次是不同的请求
			this.src = "/1217/captcha.jpg?r="+Math.random();
		}
	</script>
</body>
</html>