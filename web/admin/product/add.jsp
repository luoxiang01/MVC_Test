...
<div class="page-container">
	<form action="${pageContext.request.contextPath}/addProduct" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" name="shop_price">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '${pageContext.request.contextPath}/admin/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '${pageContext.request.contextPath}/admin/lib/webuploader/0.1.5/server/fileupload.php',
