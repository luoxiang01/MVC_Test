...
<head>
    ...
    <link href="${pageContext.request.contextPath}/admin/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet"
          type="text/css"/>
...
<div class="page-container">
    <c:forEach items="${productInfo}" var="product">
        <form action="${pageContext.request.contextPath}/editProduct" method="post" class="form form-horizontal"
              id="form-article-add">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
                <div class="formControls col-xs-8 col-sm-9">

                    <input type="text" class="input-text" value="${product.pname}" placeholder="" name="pname">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <select class="select" name="is_hot">
                        <option value="1">是</option>
                        <option value="0">否</option>
                        <%--<c:forEach var="i" begin="0" end="1" step="1">
                            <option value="${product.is_hot}">
                                <c:if test="${is_hot==1}">是</c:if>
                                <c:if test="${is_hot==0}">否</c:if>
                            </option>
                        </c:forEach>--%>
                    </select>
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="${product.market_price}" placeholder="" id=""
                           name="market_price">
                </div>
            </div>

            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商城价格：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="${product.shop_price}" placeholder=""
                           name="shop_price">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <select class="select" name="cid">
                        <c:forEach items="${categoryList}" var="category">
                            <option value=" ${product.cid }"> ${category.cname }</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="pdesc" cols="" rows="" class="textarea" placeholder="" datatype="*10-100"
                              dragonfly="true" nullmsg="备注不能为空！"
                              onKeyUp="$.Huitextarealength(this,200)">${product.pdesc}</textarea>
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    ...
                    <button class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交
                    </button>
