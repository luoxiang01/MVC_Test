...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/addProductCategory" data-title="发布商品" href="javascript:void(0)">发布商品</a></li>
					<li><a data-href="${pageContext.request.contextPath }/editProductCategory" data-title="修改商品" href="javascript:void(0)">修改商品</a></li>		
					<li><a data-href="${pageContext.request.contextPath }/productList" data-title="商品列表" href="javascript:void(0)">商品列表</a></li>					
				</ul>
			</dd>
		</dl>
